...
{
	public class BlackLatexSurfaceSnowBackgroundStyle : ModSurfaceBackgroundStyle
	{
		...
		{
            return BackgroundTextureLoader.GetBackgroundSlot(Mod, "Assets/Textures/Backgrounds/BlackLatexSurfaceSnow/Mid");
        }
