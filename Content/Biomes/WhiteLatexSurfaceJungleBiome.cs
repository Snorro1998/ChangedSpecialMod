...
namespace ChangedSpecialMod.Content.Biomes
{
    ...
    public class WhiteLatexSurfaceJungleBiome : ModBiome
	{
		...
		public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.GetInstance<WhiteLatexSurfaceJungleBackgroundStyle>();
        ...
        {
            return CityRuinsBiomeTileCount.BiomeActive(player, NPCs.GooType.White) && CityRuinsBiomeTileCount.ActiveBiomeType == CityRuinsBiomeTileCount.BiomeType.Jungle;
        }
        ...
        public override int Music
        {
            get 
            { 
                return MusicLoader.GetMusicSlot(Mod, AudioSystem.GetMusic(LastEnteredPlayer, NPCs.GooType.White)); 
            }
        }
