...
namespace ChangedSpecialMod.Content.Biomes
{
    ...
    public class BlackLatexSurfaceDesertBiome : ModBiome
	{
		...
		public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.GetInstance<BlackLatexSurfaceDesertBackgroundStyle>();
        ...
        {
            return CityRuinsBiomeTileCount.BiomeActive(player, NPCs.GooType.Black) && CityRuinsBiomeTileCount.ActiveBiomeType == CityRuinsBiomeTileCount.BiomeType.Desert;
        }
