...
{
	public class BlackLatexSurfaceBackgroundStyle : ModSurfaceBackgroundStyle
	{
		...
		{
            return BackgroundTextureLoader.GetBackgroundSlot(Mod, "Assets/Textures/Backgrounds/BlackLatexSurface/Mid");
        }
