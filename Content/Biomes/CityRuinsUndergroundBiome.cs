...
namespace ChangedSpecialMod.Content.Biomes
{
	public class CityRuinsUndergroundBiome : ModBiome
	{
        ...
        // Select Music
        public override int Music => MusicLoader.GetMusicSlot(Mod, CurrentMusic);
		...
		public override bool IsBiomeActive(Player player) {
			// Its not implemented yet, so never have this biome active
			return false;
			/*
			...
			return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) &&
				...
				ModContent.GetInstance<CityRuinsBiomeTileCount>().DryDirtBlockCount >= 40 &&
        ...
        {
            CurrentMusic = Utils.SelectRandom(Main.rand, Assets.Sounds.MusicBlackLatexZone, Assets.Sounds.MusicLabSlow, Assets.Sounds.MusicVents);
        }
