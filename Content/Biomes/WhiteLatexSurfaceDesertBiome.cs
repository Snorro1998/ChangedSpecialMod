...
namespace ChangedSpecialMod.Content.Biomes
{
    ...
    public class WhiteLatexSurfaceDesertBiome : ModBiome
	{
		...
		public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.GetInstance<WhiteLatexSurfaceDesertBackgroundStyle>();
        ...
        {
            return CityRuinsBiomeTileCount.BiomeActive(player, NPCs.GooType.White) && CityRuinsBiomeTileCount.ActiveBiomeType == CityRuinsBiomeTileCount.BiomeType.Desert;
        }
