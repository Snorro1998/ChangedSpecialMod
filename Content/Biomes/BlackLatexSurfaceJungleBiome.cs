...
{
    public class BlackLatexSurfaceJungleBiome : ModBiome
	{
		...
		public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.GetInstance<BlackLatexSurfaceJungleBackgroundStyle>();
        ...
        {
            return TileCountSystem.BiomeActive(player, NPCs.GooType.Black) && TileCountSystem.ActiveBiomeType == BiomeType.Jungle;
        }
