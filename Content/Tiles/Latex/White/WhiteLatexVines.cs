...
{
    public class WhiteLatexVines : BaseWhiteLatexTile
    {
    ...
    public class WhiteLatexVineGlobalTile : GlobalTile
    {
        private int Vine;
        ...
        public override void SetStaticDefaults()
        {
            ...
            Vine = ModContent.TileType<WhiteLatexVines>();
            ExampleBlock = ModContent.TileType<WhiteLatexGrassTile>();
        }
