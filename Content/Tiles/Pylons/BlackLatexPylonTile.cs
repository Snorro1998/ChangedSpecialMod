...
{
    public class BlackLatexPylonTile : ModPylon
    {
        ...
        public override NPCShop.Entry GetNPCShopEntry()
        {
            ...
            NPCShop.Entry shopEntry = new NPCShop.Entry(ModContent.ItemType<BlackLatexPylon>());
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<BlackLatexPylon>();
        }
        ...
        public override bool ValidTeleportCheck_BiomeRequirements(TeleportPylonInfo pylonInfo, SceneMetrics sceneData)
        {
            ...
            return CityRuinsBiomeTileCount.BlackLatexBlockCount >= CityRuinsBiomeTileCount.NBlocksNeeded;
        }
        ...
        public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
        {
            ...
            DefaultMapClickHandle(mouseOver, pylonInfo, ModContent.GetInstance<BlackLatexPylon>().DisplayName.Key, ref mouseOverText);
        }
    }
}
