...
using ChangedSpecialMod.Content.TileEntities;
using ChangedSpecialMod.Content.Items.Placeable.Pylons;
using ChangedSpecialMod.Common;

namespace ChangedSpecialMod.Content.Tiles.Pylons
{
    public class WhiteLatexPylonTile : ModPylon
    {
        ...
        public override NPCShop.Entry GetNPCShopEntry()
        {
            ...
            NPCShop.Entry shopEntry = new NPCShop.Entry(ModContent.ItemType<WhiteLatexPylon>());
            ...
            shopEntry.AddCondition(Conditions.InWhiteLatexSurfaceBiome); //ExampleConditions.InExampleBiome
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<WhiteLatexPylon>();
        }
        ...
        public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
        {
            ...
            DefaultMapClickHandle(mouseOver, pylonInfo, ModContent.GetInstance<WhiteLatexPylon>().DisplayName.Key, ref mouseOverText);
        }
    }
}
