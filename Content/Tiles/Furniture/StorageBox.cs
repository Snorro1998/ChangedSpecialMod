...
{
	public class StorageBox : ModTile
	{
		public override void SetStaticDefaults() 
		{
			...
			AddMapEntry(new Color(71, 48, 34), this.GetLocalization("MapEntry0"), MapChestName);
			AddMapEntry(new Color(92, 61, 42), this.GetLocalization("MapEntry1"), MapChestName);
			...
			RegisterItemDrop(ModContent.ItemType<Items.Placeable.Furniture.StorageBox>(), 1);
		...
		public override bool RightClick(int i, int j) 
		{
			...
			else 
			{
				if (isLocked) 
				{
					int key = ModContent.ItemType<StorageBoxKey>();
		...
		public override void MouseOver(int i, int j) 
		{
			...
			else 
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<Content.Items.Placeable.Furniture.StorageBox>();
					if (Main.tile[left, top].TileFrameX / 36 == 1) 
					{
						player.cursorItemIconID = ModContent.ItemType<StorageBoxKey>();
					}
