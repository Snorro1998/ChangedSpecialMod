	...
	public class Fan : ModTile
	{
        ...
        */
        ...
        public override void HitWire(int i, int j)
        {
            ...
            var tileFrameX = topLeftTile.TileFrameX == 0 ? 54 : 0;
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.Fan>();
        }

        // Ignore style nonsense and always drop the correct item
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            yield return new Item(ModContent.ItemType<Items.Placeable.Furniture.Fan>());
        }
    }
}
