...
{
	public class CrystalGreen : ModTile
	{
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(21, 255, 147));
        }

        // Ignore style nonsense and always drop the correct item
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            yield return new Item(ModContent.ItemType<Items.Placeable.Furniture.CrystalGreen>());
        }
        ...
        public override void EmitParticles(int i, int j, Tile tile, short tileFrameX, short tileFrameY, Color tileLight, bool visible)
        {
            if (!Main.dedServ && Main.rand.NextBool(200))
            {
                ...
                {
                    var dust = Dust.NewDustPerfect(new Vector2(i * 16, j * 16), DustID.GreenTorch, null);
                }
            }
