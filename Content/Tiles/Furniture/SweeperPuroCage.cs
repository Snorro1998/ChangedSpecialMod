...
namespace ChangedSpecialMod.Content.Tiles.Furniture
{
    public class SweeperPuroCage : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileID.Sets.CritterCageLidStyle[Type] = TileID.Sets.CritterCageLidStyle[TileID.SquirrelCage]; // This is how vanilla draws the roof of the cage
        ...
        public override void AnimateIndividualTile(int type, int i, int j, ref int frameXOffset, ref int frameYOffset)
        {
            ...
            var frameIndex = ModSupportSystem.sweeperPuroCageAnimationFrameIndex;
            ...
            //frameIndex = (index + frameIndex) % 24;
            frameIndex = ModSupportSystem.sweeperPuroCageAnimationFrameIndexs[index % 24];
