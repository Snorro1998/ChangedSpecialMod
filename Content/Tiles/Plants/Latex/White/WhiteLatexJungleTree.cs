...
{
    public class WhiteLatexJungleTree : ModTree
    {
        ...
        {
            GrowsOnTileId = [ModContent.TileType<WhiteLatexJungleGrassTile>()];
        ...
        {
            style = 0;
            return ModContent.TileType<WhiteLatexJungleTreeSapling>();
        }
