...
{
    public abstract class BaseWhiteLatexTree : ModTree
    {
        internal Asset<Texture2D> texture;
        internal Asset<Texture2D> branchesTexture;
        internal Asset<Texture2D> topsTexture;
        internal int blockItemType;
        ...
        {
            blockItemType = ModContent.ItemType<WhiteGoo>();
        }
