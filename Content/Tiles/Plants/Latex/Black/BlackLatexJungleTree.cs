...
{
    public class BlackLatexJungleTree : BaseBlackLatexTree
    {
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
            GrowsOnTileId = [ModContent.TileType<BlackLatexJungleGrassTile>()];
        ...
        {
            style = 0;
            return ModContent.TileType<BlackLatexJungleTreeSapling>();
        }
    }
}
