...
{
    public class WhiteLatexTree : ModTree
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            texture = ModContent.Request<Texture2D>("ChangedSpecialMod/Content/Tiles/Plants/WhiteLatexTree");
        ...
        private void DropItem(IEntitySource source, Player player, int x, int y)
        {
            ...
            var blockID = ModContent.ItemType<WhiteLatexBlock>();
