...
{
    public class DebugTeleportToLatex : ModItem
    {
        ...
        public override bool? UseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                player.inventory[player.selectedItem].SetDefaults(ModContent.ItemType<DebugTeleportToCorruption>());
                return true;
            }

            var position = ChangedUtils.GetInfectionBlockPosition(BiomeType.Latex);
