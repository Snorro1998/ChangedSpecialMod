...
{
    public class TigerSharkSyringe : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (descriptionTip != null)
                descriptionTip.Text = TransfurSystem.GetDescription(ModContent.NPCType<TigerShark>(), true);
        }
        ...
        public override bool? UseItem(Player player)
        {
            ...
            if (changedPlayer.TransfurTypeCurrent != null)
                ...
                TransfurSystem.SetTransfurFromNPCType(player.whoAmI, ModContent.NPCType<TigerShark>());
            return true;
        }
