...
namespace ChangedSpecialMod.Content.Items
{
    ...
    public class BlackLatexLiquidBucket : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            LiquidID_TLmod.Sets.CreateLiquidBucketItem[LiquidLoader.LiquidType<BlackLatexLiquid>()] = Type;
        ...
        public override void HoldItem(Player player)
        {
            if (!player.JustDroppedAnItem)//make sure the player hasn't just dropped an item recently
            {
                ...
                {
                    if (tile.LiquidType != LiquidLoader.LiquidType<BlackLatexLiquid>())
                    {
                        return;
                    }
                }
                ...
                tile.LiquidType = LiquidLoader.LiquidType<BlackLatexLiquid>(); //...create a liquid tile...
