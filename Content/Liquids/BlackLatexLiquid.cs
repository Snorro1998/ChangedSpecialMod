...
namespace ChangedSpecialMod.Content.Liquids
{
    ...
    public class BlackLatexLiquid : ModLiquid
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(35, 34, 41), CreateMapEntryName());
        }
        ...
        {
            return ModContent.TileType<BlackLatexTile>();
            /*
        ...
        */
        ...
        public override bool OnNPCSplash(NPC npc, bool isEnter)
        {
            ...
            {
                var npcIndex = NPC.NewNPC(new EntitySource_WorldEvent(), (int)npc.Center.X, (int)npc.Bottom.Y, ModContent.NPCType<MaleDarkLatex>(), 0, 0);
