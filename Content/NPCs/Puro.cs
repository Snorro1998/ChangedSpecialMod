...
namespace ChangedSpecialMod.Content.NPCs
{
	...
	public partial class Puro : ModNPC
	{
		...
		public override string GetChat() 
		{
            ...
            NPCPortraitSystem.UpdatePortrait(ModContent.NPCType<Puro>(), emotionText);
            return dialogueText;
		}
        ...
        public override void AddShops() 
        {
			new NPCShop(Type, Shops[0].InternalName)
                ...
                .Add<Items.Placeable.Latex.Black.BlackLatexSand>()
                .Add<Items.Placeable.Latex.Black.BlackLatexBlock>()
                .Add<Items.Placeable.Latex.White.WhiteLatexSand>()
                .Add<Items.Placeable.Latex.White.WhiteLatexBlock>()
